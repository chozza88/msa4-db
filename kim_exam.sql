...
-- 문제 3. [5점]
-- 1995년 1월 1일 이후에 입사한 
-- 직원(퇴사자 포함)의 정보를 입사일 순서대로 정렬하여 조회하세요.
...
-- 문제 4. [3점]
-- 현재 각 부서별로 몇 명의 직원이 있는지 계산하고, 
-- 직원 수가 많은 부서부터 순서대로 조회하세요.
...
GROUP BY depe.dept_code, dept.dept_name
...
-- 
-- rankmanagement의 FK인 userid는 users의 userid를 참조
-- Table: users
-- 
